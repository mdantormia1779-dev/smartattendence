...
export default function Sidebar() {
    ...
    useEffect(() => {
        ...
        window.addEventListener("toggle-orgadmin-sidebar", handleToggle);
        window.addEventListener("close-orgadmin-sidebar", handleClose);

        return () => {
            window.removeEventListener("toggle-orgadmin-sidebar", handleToggle);
            window.removeEventListener("close-orgadmin-sidebar", handleClose);
        };
    }, []);
    ...
    const renderOrgSidebarContent = (isMobile = false) => (
        <>
            ...
            <div className="p-3 mx-4 my-2.5 bg-neutral-50 rounded-2xl border border-neutral-200/80 shrink-0">
