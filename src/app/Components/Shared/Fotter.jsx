...
const Footer = () => {
    return (
        <footer className="w-full bg-[#FBF9F5] border-t border-gray-200 py-12 px-6 md:px-16 text-gray-600">
            ...
            <div className="max-w-7xl mx-auto pt-8 border-t border-gray-200 flex flex-col md:flex-row items-center justify-between text-xs text-gray-500 gap-4">
                <p>© 2026 AttendanceERP. All rights reserved.</p>
                
                {/* Extra Links on Right (Optional/Matching Image) */}
